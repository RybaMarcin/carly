package org.carly.core.paymentcardmanagement.mapper;
...
public class PaymentCardResponseMapper implements MapperService<PaymentCardResponse, PaymentCard> {
    ...
    @Override
    public PaymentCardResponse simplifyRestObject(PaymentCard domain) {
        PaymentCardResponse rest = new PaymentCardResponse();
        return mapFromDomainObject(domain, rest);
    }

    @Override
    public PaymentCard simplifyDomainObject(PaymentCardResponse rest) {
