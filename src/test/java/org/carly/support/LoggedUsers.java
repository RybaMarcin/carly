...
public class LoggedUsers {
    ...
    public static LoggedUser aLoggedUser1() {
        return new LoggedUser(LOGGED_USER_ID_1, LOGGED_USER_FIRST_NAME_1, LOGGED_USER_LAST_NAME_1, LOGGED_USER_EMAIL_1, LOGGED_USER_PASSWORD, LOGGED_USER_AUTHORITIES_1, LOGGED_USER_ENABLE_1);
    }
